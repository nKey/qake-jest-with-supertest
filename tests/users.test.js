    ...
    it("should return 201 and check user with name 'TestAPI' and email 'testapi@mail.com' exists", () => {
        return request(ApiUrl)
            ...
            .then((response) => {
                ...
                expect(postUser.address.zipcode).toEqual(wantedPostUser.address.zipcode);
                expect(postUser.address.geo.lat).toEqual(wantedPostUser.address.geo.lat);
                expect(postUser.address.geo.lng).toEqual(wantedPostUser.address.geo.lng);
                ...
                expect(postUser.company.catchPhrase).toEqual(wantedPostUser.company.catchPhrase);
    ...
    it("should return 200 and check user name is 'Clementina DuBuque'", () => {
        return request(ApiUrl)
            ...
            .then((response) => {
                ...
                expect(user.company.catchPhrase).toEqual("Centralized empowering task-force");
    ...
    it("should return 200 and check user was update to 'TestApiPUTJest' and email 'testapijest@mail.com", () => {
        return request(ApiUrl)
            ...
            .then((response) => {
                ...
                expect(putUser.company.catchPhrase).toEqual(wantedPutUser.company.catchPhrase);
